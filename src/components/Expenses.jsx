    ...
    <div style={{ padding: '15px', direction: 'rtl', fontFamily: "'Tajawal', sans-serif", minHeight: '100vh' }}>
      ...
      <div className="glass-card">
        <form onSubmit={handleSubmit}>
          ...
          <select className="glass-input" value={expense.category} onChange={(e) => setExpense({ ...expense, category: e.target.value })} style={{ marginBottom: '12px' }}>
          ...
          <button type="submit" className="btn-primary" style={{ backgroundColor: '#7f8c8d', boxShadow: '0 4px 15px rgba(127, 140, 141, 0.3)' }}>
            <Save size={20} /> حفظ المصروف
          </button>
        </form>
      </div>
