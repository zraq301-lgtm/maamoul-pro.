...
const Dashboard = ({ 
  ...
  suppliersData = [], 
  staffData = [],
  productionHistory = [], // ممررة لدعم وظائف الإنتاج وعرضها في الجدول
  stock = [],              // ممررة لدعم حسابات المخزن والمواد الخام
  ...
  useEffect(() => {
    if (typeof fetchData === 'function') {
      fetchData(); // تحديث فوري ومزامنة المؤشرات والبيانات السحابية والمحلية لخصم الخامات
    }
