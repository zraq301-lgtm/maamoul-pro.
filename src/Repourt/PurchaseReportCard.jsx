    ...
    <div style={{ padding: '15px', direction: 'rtl', fontFamily: "'Tajawal', sans-serif" }}>
      ...
      <div className="glass-card" style={{ borderRight: '6px solid #9b59b6' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '10px' }}>
          <ShoppingBag color="#9b59b6" size={24} />
          <h3 style={{ margin: 0, fontSize: '1.1rem' }}>تقرير المشتريات التفصيلي</h3>
        </div>

        <div style={{ background: 'rgba(243, 239, 249, 0.8)', padding: '14px', borderRadius: '14px', textAlign: 'center', marginBottom: '15px' }}>
          <span style={{ fontSize: '0.85rem', color: '#64748b' }}>إجمالي المشتريات:</span>
          <div style={{ fontSize: '1.5rem', fontWeight: '800', color: '#9b59b6' }}>{totalPurchases.toLocaleString()} ج.م</div>
        </div>

        <p style={{ fontSize: '0.85rem', color: '#64748b', margin: '0 0 15px 0' }}>
          عدد الفواتير: {inventory.length}
        </p>

        <button onClick={exportPurchasesExcel} className="btn-primary" style={{ backgroundColor: '#9b59b6', boxShadow: '0 4px 15px rgba(155, 89, 182, 0.3)' }}>
