    ...
    <div style={{ padding: '15px', direction: 'rtl', fontFamily: "'Tajawal', sans-serif" }}>
      ...
      <div className="glass-card" style={{ borderRight: '6px solid #2ecc71' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '10px' }}>
          <Tag color="#2ecc71" size={24} />
          <h3 style={{ margin: 0, fontSize: '1.1rem' }}>تقرير المبيعات والطلبات</h3>
        </div>

        <div style={{ background: 'rgba(236, 253, 245, 0.8)', padding: '14px', borderRadius: '14px', textAlign: 'center', marginBottom: '15px' }}>
          <span style={{ fontSize: '0.85rem', color: '#64748b' }}>إجمالي المبيعات:</span>
          <div style={{ fontSize: '1.5rem', fontWeight: '800', color: '#2ecc71' }}>{totalSales.toLocaleString()} ج.م</div>
        </div>

        <p style={{ fontSize: '0.85rem', color: '#64748b', margin: '0 0 15px 0' }}>
          عدد العمليات: {salesData.length}
        </p>

        <button onClick={exportSalesExcel} className="btn-primary" style={{ backgroundColor: '#2ecc71', boxShadow: '0 4px 15px rgba(46, 204, 113, 0.3)' }}>
